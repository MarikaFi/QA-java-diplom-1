...
public class IngredientTest {
    ...
    public void getPrice() {
        ...
        assertEquals("Цена отличается", expectedPrice, actual, 0);
    }
    ...
    public void getName() {
        ...
        assertEquals("Наименование отличается", expectedName, actual);
    ...
    public void getType() {
        ...
        assertEquals("Тип отличается", expectedType, actual);
    }
}
